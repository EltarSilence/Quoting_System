<?php
	...
	function newScommessa($data){
		...
		foreach (STUDENTI as $value) {
	        ...
	        //lettura voti esatti
		        $EXACT10 = $excel->setActiveSheetIndex(0)->getCell('A6')->getCalculatedValue();
		        $EXACT9h = $excel->setActiveSheetIndex(0)->getCell('A7')->getCalculatedValue();
		        $EXACT9 = $excel->setActiveSheetIndex(0)->getCell('A8')->getCalculatedValue();
		        $EXACT8h = $excel->setActiveSheetIndex(0)->getCell('A9')->getCalculatedValue();
		        $EXACT8 = $excel->setActiveSheetIndex(0)->getCell('A10')->getCalculatedValue();
		        $EXACT7h = $excel->setActiveSheetIndex(0)->getCell('A11')->getCalculatedValue();
		        $EXACT7 = $excel->setActiveSheetIndex(0)->getCell('A12')->getCalculatedValue();
		        $EXACT6h = $excel->setActiveSheetIndex(0)->getCell('A13')->getCalculatedValue();
		        $EXACT6 = $excel->setActiveSheetIndex(0)->getCell('A14')->getCalculatedValue();
		        $EXACT5h = $excel->setActiveSheetIndex(0)->getCell('A15')->getCalculatedValue();
		        $EXACT5 = $excel->setActiveSheetIndex(0)->getCell('A16')->getCalculatedValue();
		        $EXACT4h = $excel->setActiveSheetIndex(0)->getCell('A17')->getCalculatedValue();
		        $EXACT4 = $excel->setActiveSheetIndex(0)->getCell('A18')->getCalculatedValue();
		        $EXACT3h = $excel->setActiveSheetIndex(0)->getCell('A19')->getCalculatedValue();
		        $EXACT3 = $excel->setActiveSheetIndex(0)->getCell('A20')->getCalculatedValue();
		        $EXACT2 = $excel->setActiveSheetIndex(0)->getCell('A21')->getCalculatedValue();
		        $EXACT1 = $excel->setActiveSheetIndex(0)->getCell('A22')->getCalculatedValue();
